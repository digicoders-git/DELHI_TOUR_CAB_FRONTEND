...
import { FaBus, FaClock, FaRupeeSign, FaCheckCircle, FaInfoCircle, FaSpinner } from 'react-icons/fa';
            ...
            <div className="bg-gradient-to-r from-orange-600 to-orange-400 py-12 md:py-16 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 relative z-10">
                    ...
                    <p className="text-orange-100 text-base md:text-lg max-w-2xl">
                        Affordable same-day Agra tour by luxury AC bus. Visit Taj Mahal, Agra Fort & more — return same evening.
                    </p>
                </div>
            </div>
