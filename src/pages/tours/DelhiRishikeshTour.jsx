...
const DelhiRishikeshTour = () => {
    const tourData = {
        ...
        carss: [
            ...
            { name: "Sedan Swift Dzire (4+1)", price: "₹9,000/-", image: dzire },
            { name: "Budget SUV Suzuki Ertiga (6+1)", price: "₹11,000/-", image: ertiga2 },
            { name: "Luxury SUV Kia Carens (6+1)", price: "₹13,500/-", image: kiacarens },
